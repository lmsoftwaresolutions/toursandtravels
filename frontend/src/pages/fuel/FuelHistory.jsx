        ...
        <div className="overflow-x-auto custom-scrollbar">
          <table className="w-full border-separate border-spacing-0">
            ...
            <tbody className="divide-y divide-slate-50">
              {fuelData.length === 0 ? (
                <tr><td colSpan="5" className="p-20 text-center text-slate-400 font-bold uppercase tracking-widest text-[10px]">No fuel entries found</td></tr>
              ) : (
                fuelData.map(f => (
                  <tr key={f.id} className="group hover:bg-slate-50/40 transition-colors">
                    <td className="p-6">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-[10px] font-bold text-slate-400 uppercase">
                            {f.vendor || f.fuel_type || "Fuel"}
                          </span>
                        </div>
                      </div>
                    </td>
                    <td className="p-6 hidden md:table-cell text-right">
                      <div className="text-sm font-bold text-slate-700">{f.quantity} L</div>
                      <div className="text-[10px] text-slate-400 font-black uppercase tracking-tighter">@ ₹{f.rate_per_litre}/L</div>
                    </td>
                    <td className="p-6 text-right text-base font-black text-slate-800">
