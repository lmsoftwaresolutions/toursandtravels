      ...
      <div className="space-y-12">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h4 className="text-xs font-black uppercase tracking-widest text-slate-500">Fuel & Party Fuel Entries</h4>
            <button
              type="button"
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 border-t border-slate-100 pt-3">
                <div className="space-y-1">
                  <span className="text-[9px] font-black text-black uppercase ml-1 text-[8px]">Vendor</span>
                  <select
                    value={entry.vendor_deduction_vendor || ""}
                    onChange={(e) => onEntryChange(index, "vendor_deduction_vendor", e.target.value)}
                    className="w-full h-10 px-3 bg-rose-50/30 border border-rose-100 rounded-xl text-xs font-bold text-slate-700 shadow-inner"
                  >
                    <option value="">Select Vendor</option>
                    {fuelVendors.map(v => (
                      <option key={v.id} value={v.name}>{v.name}</option>
                ...
                <div className="space-y-1">
                  <span className="text-[9px] font-black text-black uppercase ml-1 text-[8px]">Party Fuel Description</span>
                  <input
                    type="text"
                    value={entry.vendor_deduction_description || ""}
                    onChange={(e) => onEntryChange(index, "vendor_deduction_description", e.target.value)}
                    className="w-full h-10 px-3 bg-rose-50/30 border border-rose-100 rounded-xl text-xs font-bold text-slate-700 shadow-inner"
                    placeholder="e.g. Advance paid"
                  />
                </div>
                <div className="space-y-1">
                  <span className="text-[9px] font-black text-black uppercase ml-1 text-[8px]">Amount</span>
                  <div className="relative">
                ...
                <div className="space-y-1">
                  <span className="text-[9px] font-black text-black uppercase ml-1 text-[8px]">Note</span>
                  <input
                    type="text"
                    value={entry.vendor_deduction_note || ""}
                    onChange={(e) => onEntryChange(index, "vendor_deduction_note", e.target.value)}
                    className="w-full h-10 px-3 bg-rose-50/30 border border-rose-100 rounded-xl text-xs font-bold text-slate-700 shadow-inner"
